...
This project is indexed by GitNexus as **WeatherBot** (2249 symbols, 3149 relationships, 93 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
