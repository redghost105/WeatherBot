...
This project is indexed by GitNexus as **WeatherBot** (2312 symbols, 3207 relationships, 93 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
