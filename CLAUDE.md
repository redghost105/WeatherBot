...
This project is indexed by GitNexus as **WeatherBot** (3781 symbols, 5830 relationships, 176 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
